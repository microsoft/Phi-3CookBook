...
* [Fine-tuning Phi-3]()
    ...
    * [Fine-tuning in Lora](./md/04.Fine-tuning/FineTuning_Lora.md)(✅)
    * [Fine-tuning in Azure AI Studio](./md/04.Fine-tuning/FineTuning_MicrosotOlive.md)(✅)
    * [Fine-tuning in Microsoft Olive](./md/04.Fine-tuning/FineTuning_Lora.md)(✅)
* [Evaluation Phi-3]()
