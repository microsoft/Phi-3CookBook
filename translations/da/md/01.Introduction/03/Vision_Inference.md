...
Phi-3-vision-128k-instruct gør det muligt for Phi-3 ikke kun at forstå sprog, men også at se verden visuelt. Med Phi-3-vision-128k-instruct kan vi løse forskellige visuelle problemer som f.eks. OCR, tabelanalyse, objekgenkendelse, billedbeskrivelse osv. Vi kan nemt udføre opgaver, der tidligere krævede omfattende datatræning. Følgende er relaterede teknikker og anvendelsesscenarier nævnt af Phi-3-vision-128k-instruct.

## **0. Forberedelse**

Sørg for, at følgende Python-biblioteker er installeret, inden du går i gang (Python 3.10+ anbefales)
...
## **1. Analysér billedet med Phi-3-Vision**
...
Ud over at analysere billedet kan vi også udtrække information fra billedet. Dette er OCR-processen, som vi tidligere skulle skrive kompleks kode for at udføre.
