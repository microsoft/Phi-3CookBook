...
- Opret en API Rest med følgende metoder:
    - Hent en liste over øl ved hjælp af sideforskydning og grænse.
    - Hent detaljer om en øl via id.
    - Søg efter øl via navn, beskrivelse, tagline, madparringer og pris.
...
- (Valgfrit) Slider til at filtrere produkter efter pris.
