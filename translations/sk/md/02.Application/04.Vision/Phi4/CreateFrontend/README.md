## **Použitie Phi-4-multimodal na čítanie obrázkov a generovanie kódu**

Phi-4-multimodal má výkonné schopnosti na čítanie obrázkov. Skúsme použiť Python na implementáciu nasledujúcich funkcií. Obrázok je stránka ChatGPT.
