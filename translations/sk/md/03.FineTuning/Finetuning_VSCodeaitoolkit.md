## Vitajte v AI Toolkit pre VS Code
...
Ak chcete použiť `prompt flow` in VS Code, please refer to this [Quick Start](https://microsoft.github.io/promptflow/how-to-guides/quick-start.html).
