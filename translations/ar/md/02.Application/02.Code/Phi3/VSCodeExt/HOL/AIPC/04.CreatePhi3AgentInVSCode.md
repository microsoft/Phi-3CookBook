...
في Visual Studio Code Copilot Chat، يمكنك إدارة المشروع بأكمله من خلال @workspace. بالنسبة لسيناريوهات المؤسسات، يمكننا أيضًا تخصيص وكيل Copilot Chat بمرونة أكبر.

في المختبر السابق، قمنا بدمج NPU والسحابة لإكمال امتداد Visual Studio Code لوكيل Phi3.
...
لم يتم دمج واجهة برمجة تطبيقات Visual Studio Code Chat بعد في واجهة برمجة التطبيقات الأساسية، ولكن يمكن إضافتها الآن من خلال الامتدادات.
...
يمكنك تشغيل **npm install** في الطرفية وتصحيح امتدادك لاختباره.
