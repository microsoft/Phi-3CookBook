## **Functie-aanroep in Phi-4-mini**

Functie-aanroep verscheen voor het eerst in de Phi Family-reeks, en nu kun je het gebruiken via Phi-4-mini.

Dit voorbeeld toont de simulatie van Premier League-resultaten. Het doel is dat Phi-4-mini real-time wedstrijdinformatie levert. Hieronder staat de voorbeeldcode:
