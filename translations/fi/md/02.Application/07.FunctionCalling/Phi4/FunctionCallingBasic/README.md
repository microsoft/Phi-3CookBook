## **Funktioiden kutsuminen Phi-4-mini:ssä**

Funktioiden kutsuminen ilmestyi ensimmäisen kerran Phi Family -perheessä, ja nyt sitä voi käyttää myös Phi-4-mini:ssä.

Tässä esimerkissä havainnollistetaan Valioliigan tulosten simulointia. Tavoitteena on, että Phi-4-mini toimittaa reaaliaikaista tietoa peleistä. Alla on esimerkkikoodi:
