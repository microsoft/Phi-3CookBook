## **Extrageți transcrieri audio folosind Phi-4-multimodal**

Phi-4-multimodal este un model multimodal complet care poate utiliza audio pe lângă text și imagini. Haideți să vedem cum să-l folosim.
