# **Lab 3 - Creare un agente @PHI3 in GitHub Copilot Chat**
...
### **1. Creare un'estensione di sviluppo per VSCode**
...
***NOTA:*** Utilizza Typescript e WebPack come soluzione tecnica per questo progetto.

### **2. Aggiungere vscode.d.ts**

L'API di Visual Studio Code Chat non è ancora stata integrata nell'API principale, ma è attualmente aggiunta tramite estensioni.
