...
Proszę odnieść się do tego linku [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension), aby utworzyć projekt rozszerzenia.

***NOTE:*** Proszę użyć Typescript oraz WebPack jako rozwiązania technicznego dla tego projektu.

### **2. Dodaj vscode.d.ts**

API Visual Studio Code Chat nie zostało jeszcze zintegrowane z API kodu, ale obecnie jest dodawane za pomocą rozszerzeń.
...
Gratulacje! Ukończyłeś wszystkie laboratoria. Mam nadzieję, że to pomoże Ci zrozumieć rodzinę Phi-3 i jak korzystać z GitHub Copilot Chat.
