# **Lab 3 - Tworzenie agenta @PHI3 w GitHub Copilot Chat**

W Visual Studio Code Copilot Chat możesz zarządzać całym projektem za pomocą @workspace. W scenariuszach korporacyjnych możemy również bardziej elastycznie dostosowywać agenta Copilot Chat.
...
Proszę zapoznać się z tym linkiem [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension), aby stworzyć projekt rozszerzenia.

***NOTE:*** Proszę użyć Typescript i WebPack jako rozwiązania technicznego dla tego projektu.

### **2. Dodaj vscode.d.ts**

API Visual Studio Code Chat nie zostało jeszcze zintegrowane z API kodu, ale można je obecnie dodać za pomocą rozszerzeń.
...
Możesz uruchomić **npm install** w terminalu i debugować swoje rozszerzenie, aby je przetestować.

***Pobierz przykładowy kod*** [Kliknij tutaj](../../../../../../../../../code/07.Lab/01/AIPC)
...
export function activate(extcontext: vscode.ExtensionContext) {
	...
	const phi3handler: vscode.ChatRequestHandler = async (request: vscode.ChatRequest, context: vscode.ChatContext, stream: vscode.ChatResponseStream, token: vscode.CancellationToken): Promise<IPHI3ChatResult> => {
		...
		if (request.command == 'img') {
			...
			{
				var result = "```txt"+"\n\n"+"Proszę zadawać pytania w taki sposób: Twoje pytanie (IMG_URL:https://example.com/image.jpg)"+"\n\n"++"```";
