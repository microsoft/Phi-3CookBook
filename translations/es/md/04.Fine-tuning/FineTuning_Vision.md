...
Este es el soporte oficial para el ajuste fino de Phi-3.5-vision usando las bibliotecas de huggingface.
...
Proveemos dos scripts de ejemplo para el ajuste fino, uno para DocVQA y otro para la clasificación de memes de odio.
...
Usamos un dataset mínimo de clasificación de video (un subconjunto de UCF-101) como un ejemplo de extremo a extremo para demostrar cómo convertir tu dataset personalizado al formato requerido y ajustar fino Phi-3.5-vision en él.
...
Para la anotación `jsonl`, cada línea debería ser un diccionario como:
```json
...
Ingresa "cuotas" en el cuadro de búsqueda y luego selecciona Cuotas.
![Cuota](https://learn.microsoft.com/azure/quotas/media/quickstart-increase-quota-portal/quotas-portal.png)

En la página de Descripción general, selecciona un proveedor, como Compute o AML.

**Nota** Para todos los proveedores que no sean Compute, verás una columna Solicitar aumento en lugar de la columna Ajustable descrita a continuación. Allí, puedes solicitar un aumento para una cuota específica o crear una solicitud de soporte para el aumento.
...
Tu solicitud será revisada y serás notificado si la solicitud puede ser cumplida. Esto usualmente ocurre en unos pocos minutos.
...
Método de entrenamiento | Modelo de visión congelado | Tipo de datos | Rango de LoRA | Alpha de LoRA | Tamaño de batch | Tasa de aprendizaje | Épocas | Precisión
--- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Método de entrenamiento | Tipo de datos | Rango de LoRA | Alpha de LoRA | Tamaño de batch | Tasa de aprendizaje | Épocas | ANLS
--- | --- | --- | --- | --- | --- | --- | --- |
