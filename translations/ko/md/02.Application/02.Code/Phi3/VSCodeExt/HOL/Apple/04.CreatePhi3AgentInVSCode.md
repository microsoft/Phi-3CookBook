...
Visual Studio Code Copilot Chat에서는 @workspace를 통해 전체 프로젝트를 관리할 수 있습니다. 기업 환경에서는 Copilot Chat의 에이전트를 더욱 유연하게 커스터마이징할 수도 있습니다.

지난 Lab에서는 MX 프레임워크와 클라우드를 결합하여 Phi3 에이전트를 위한 Visual Studio Code 확장을 완성했습니다.

![agent](../../../../../../../../../translated_images/vscode_agent.409cc20073ede69c5bd4db0d611aff68cf40ed88d8c334a899a341c6ba82f013.ko.png)

### **1. VSCode 개발 확장 생성하기**

이 링크를 참조하여 확장 프로젝트를 생성하세요: [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension)

***NOTE:*** 이 프로젝트의 기술 솔루션으로 Typescript와 WebPack을 사용하세요.

### **2. vscode.d.ts 추가하기**

Visual Studio Code Chat API는 아직 코드 API에 통합되지 않았지만, 현재는 확장을 통해 추가할 수 있습니다.
...
축하합니다! 모든 Lab을 완료하셨습니다. 이번 Lab을 통해 Phi-3 패밀리와 GitHub Copilot Chat 사용 방법을 이해하는 데 도움이 되었길 바랍니다.
...
**면책 조항**:  
이 문서는 AI 기반 기계 번역 서비스를 사용하여 번역되었습니다. 정확성을 위해 노력하고 있으나, 자동 번역에는 오류나 부정확성이 포함될 수 있습니다. 원어로 작성된 원본 문서를 신뢰할 수 있는 권위 있는 자료로 간주해야 합니다. 중요한 정보의 경우, 전문적인 인간 번역을 권장합니다. 이 번역 사용으로 인해 발생하는 오해나 잘못된 해석에 대해 당사는 책임을 지지 않습니다.