...
함수 호출은 처음 Phi Family에서 등장했으며, 이제 Phi-4-mini를 통해 사용할 수 있습니다.

이 예제는 프리미어 리그 결과를 시뮬레이션하는 과정을 보여줍니다. 목표는 Phi-4-mini가 실시간 경기 정보를 제공하도록 하는 것입니다. 아래는 샘플 코드입니다:
...
**면책 조항**:  
이 문서는 AI 기반 기계 번역 서비스를 사용하여 번역되었습니다. 정확성을 위해 최선을 다하고 있지만, 자동 번역에는 오류나 부정확성이 포함될 수 있습니다. 원문은 해당 언어로 작성된 문서를 권위 있는 자료로 간주해야 합니다. 중요한 정보에 대해서는 전문적인 인간 번역을 권장합니다. 이 번역 사용으로 인해 발생하는 오해나 잘못된 해석에 대해 당사는 책임을 지지 않습니다.