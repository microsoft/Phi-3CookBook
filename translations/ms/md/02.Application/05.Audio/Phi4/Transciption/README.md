## **Menjana transkrip audio menggunakan Phi-4-multimodal**

Phi-4-multimodal ialah model penuh-modal yang boleh menggunakan audio selain teks dan imej. Mari kita lihat cara menggunakannya.
