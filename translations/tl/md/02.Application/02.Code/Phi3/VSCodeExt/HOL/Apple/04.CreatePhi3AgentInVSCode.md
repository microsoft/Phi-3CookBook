...
Sa Visual Studio Code Copilot Chat, maaari mong pamahalaan ang buong proyekto gamit ang @workspace. Para sa mga enterprise na sitwasyon, maaari rin nating i-customize ang Agent ng Copilot Chat nang mas flexible.

Sa nakaraang Lab, pinagsama natin ang MX framework at cloud upang makumpleto ang isang Visual Studio Code Extension para sa Phi3 Agent.
...
Mangyaring sumangguni sa link na ito [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension) upang gumawa ng Extension project.

***NOTE:*** Mangyaring gumamit ng Typescript, WebPack bilang teknikal na solusyon para sa proyektong ito.

### **2. Magdagdag ng vscode.d.ts**

Ang Visual Studio Code Chat API ay hindi pa naisama sa code API, ngunit maaari na itong idagdag gamit ang mga extension.
...
***I-download ang Sample Code*** [I-click dito](../../../../../../../../../code/07.Lab/01/Apple)
...
Congratulations! Natapos mo na ang lahat ng labs. Sana makatulong ito sa iyong pag-unawa sa Phi-3 Family at kung paano gamitin ang GitHub Copilot Chat.
...
**Paunawa**:  
Ang dokumentong ito ay isinalin gamit ang mga serbisyo ng AI na batay sa makina. Habang sinisikap naming maging wasto, pakitandaan na ang mga awtomatikong pagsasalin ay maaaring maglaman ng mga pagkakamali o kamalian. Ang orihinal na dokumento sa sariling wika nito ang dapat ituring na awtoritatibong sanggunian. Para sa mahalagang impormasyon, inirerekomenda ang propesyonal na pagsasalin ng tao. Hindi kami mananagot sa anumang hindi pagkakaunawaan o maling interpretasyon na dulot ng paggamit ng pagsasaling ito.