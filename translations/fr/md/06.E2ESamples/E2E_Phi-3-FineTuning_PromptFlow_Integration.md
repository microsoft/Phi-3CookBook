...
![Aperçu de l'intégration Phi-3-FineTuning_PromptFlow](../../../../translated_images/00-01-architecture.8105090d271b94fffec713da4c928ae31366b3521c18eec086cd4d2a3bddb3c4.fr.png)
...
1. Sur la page Ajouter une attribution de rôle, effectuez les tâches suivantes :
    ...
    - Sur la page Membres, sélectionnez **+ Sélectionner les membres**.
    - Sur la page Sélectionner les identités gérées, sélectionnez votre **Abonnement** Azure.
    - Sur la page Sélectionner les identités gérées, sélectionnez l'**Identité gérée** sur **Identité gérée**.
    - Sur la page Sélectionner les identités gérées, sélectionnez l'Identité Gérée que vous avez créée. Par exemple, *finetunephi-managedidentity*.
    - Sur la page Sélectionner les identités gérées, sélectionnez **Sélectionner**.

    ![Sélectionner identité gérée.](../../../../translated_images/01-10-select-managed-identity.980c5177907f18065d2e28097b3629e3d66530902a39899aa4dd1214493a65d0.fr.png)
...
1. Sélectionnez le dossier *finetune-phi* que vous avez créé, qui se trouve à *C:\Users\VotreNomUtilisateur\finetune-phi*.
...
1. Dans le volet de gauche de Visual Studio Code,
