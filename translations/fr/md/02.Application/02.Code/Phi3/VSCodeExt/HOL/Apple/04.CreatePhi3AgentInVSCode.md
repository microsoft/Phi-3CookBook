...
Dans le dernier Lab, nous avons combiné le framework MX et le cloud pour réaliser une extension Visual Studio Code pour l'agent Phi3.
...
***NOTE :*** Veuillez utiliser Typescript et WebPack comme solutions techniques pour ce projet.
