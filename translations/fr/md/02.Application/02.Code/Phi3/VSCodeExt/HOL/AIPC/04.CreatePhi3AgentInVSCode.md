...
Dans Visual Studio Code Copilot Chat, vous pouvez gérer l'intégralité du projet via @workspace. Pour des scénarios d'entreprise, nous pouvons également personnaliser l'Agent de Copilot Chat de manière plus flexible.

Dans le dernier laboratoire, nous avons combiné NPU et cloud pour créer une extension Visual Studio Code pour l'agent Phi3.
...
Félicitations ! Vous avez terminé tous les laboratoires. J'espère que cela vous aide à comprendre la famille Phi-3 et comment utiliser GitHub Copilot Chat.
