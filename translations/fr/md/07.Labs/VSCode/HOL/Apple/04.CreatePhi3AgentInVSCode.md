# **Lab 3 - Créez un agent @PHI3 dans GitHub Copilot Chat**
...
### **1. Créez une extension de développement VSCode**
...
### **2. Ajoutez vscode.d.ts**

L'API Visual Studio Code Chat n'a pas encore été fusionnée dans l'API code, mais est maintenant ajoutée via des extensions.
