...
- **Създаване на папка за превод**: Навигирайте до съответната секция и създайте папка за превод за езика, към който допринасяте. Например:
  - За секцията "въведение": `PhiCookBook/md/01.Introduce/translations/<language_code>/`
  - За секцията "бърз старт": `PhiCookBook/md/02.QuickStart/translations/<language_code>/`
...
- **Форматиране на URL адреси**: Поставяйте всички URL адреси в квадратни скоби, последвани от кръгли скоби, без допълнителни интервали около тях. Например: `[example](https://www.microsoft.com)`.
