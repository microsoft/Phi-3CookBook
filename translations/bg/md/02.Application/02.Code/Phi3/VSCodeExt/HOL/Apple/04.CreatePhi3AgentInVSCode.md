...
В последната лаборатория комбинирахме MX framework и облака, за да завършим разширение на Visual Studio Code за агент Phi3.
...
API-то на Visual Studio Code Chat все още не е интегрирано в основното API, но може да бъде добавено чрез разширения.
...
***ЗАБЕЛЕЖКА:*** Моля, стартирайте го във Visual Studio Code Insiders 1.90+.
...
Можете да стартирате **npm install** в терминала и да дебъгвате разширението си, за да го тествате.
