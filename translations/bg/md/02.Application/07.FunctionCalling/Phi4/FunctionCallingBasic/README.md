...
Извикването на функции за първи път се появи в семейството на Phi, а сега можете да го използвате и чрез Phi-4-mini.

Този пример демонстрира симулация на резултати от Висшата лига. Целта е Phi-4-mini да предоставя информация за мачовете в реално време. По-долу е даден примерен код:
