## **Chamando funções no Phi-4-mini**

A chamada de funções surgiu pela primeira vez na família Phi Family, e agora você pode utilizá-la através do Phi-4-mini.

Este exemplo demonstra a simulação de resultados da Premier League. O objetivo é que o Phi-4-mini forneça informações dos jogos em tempo real. Abaixo está o código de exemplo:
