...
فنکشن کالنگ پہلی بار Phi Family میں متعارف ہوئی، اور اب آپ اسے Phi-4-mini کے ذریعے استعمال کر سکتے ہیں۔

یہ مثال پریمیئر لیگ کے نتائج کی سمولیشن کو ظاہر کرتی ہے۔ مقصد یہ ہے کہ Phi-4-mini حقیقی وقت میں کھیل کی معلومات فراہم کرے۔ نیچے نمونہ کوڈ دیا گیا ہے:
...
**اعلانِ لاتعلقی**:  
یہ دستاویز مشین پر مبنی AI ترجمہ خدمات کا استعمال کرتے ہوئے ترجمہ کی گئی ہے۔ اگرچہ ہم درستگی کے لیے کوشاں ہیں، براہ کرم آگاہ رہیں کہ خودکار ترجمے میں غلطیاں یا خامیاں ہو سکتی ہیں۔ اصل دستاویز کو اس کی مقامی زبان میں مستند ذریعہ سمجھا جانا چاہیے۔ اہم معلومات کے لیے، پیشہ ور انسانی ترجمہ تجویز کیا جاتا ہے۔ ہم اس ترجمے کے استعمال سے پیدا ہونے والی کسی بھی غلط فہمی یا غلط تشریح کے ذمہ دار نہیں ہیں۔