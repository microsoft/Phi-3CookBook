...
在上一个实验中，我们结合 MX 框架和云端完成了一个 Phi3 代理的 Visual Studio Code 扩展。
...
Visual Studio Code Chat API 还未合并到代码 API 中，但现在可以通过扩展添加。
...
**免责声明**：
本文档是使用机器翻译服务翻译的。尽管我们努力确保准确性，但请注意，自动翻译可能包含错误或不准确之处。应将原始语言的文档视为权威来源。对于关键信息，建议使用专业人工翻译。我们对使用此翻译所引起的任何误解或曲解不承担责任。