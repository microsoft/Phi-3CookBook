...
在上一个实验中，我们结合 NPU 和云完成了一个 Phi3 代理的 Visual Studio Code 扩展。
...
***NOTE:*** 请使用 Typescript 和 WebPack 作为本项目的技术解决方案。
...
**免责声明**：
本文档是使用基于机器的人工智能翻译服务翻译的。尽管我们努力确保准确性，但请注意，自动翻译可能包含错误或不准确之处。应将原始语言的文档视为权威来源。对于关键信息，建议使用专业的人工翻译。对于因使用此翻译而产生的任何误解或误读，我们不承担责任。