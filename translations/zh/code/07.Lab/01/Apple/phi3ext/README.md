...
> 提示：许多流行的扩展使用动画。这是展示你的扩展的一个极好方式！我们推荐简短、集中的动画，便于用户跟随。

## 要求

如果你的扩展有任何要求或依赖，请添加一个章节描述这些要求以及如何安装和配置它们。
...
你可以使用 Visual Studio Code 撰写你的 README。以下是一些有用的编辑器快捷键：
...
**免责声明**：  
本文件通过基于机器的人工智能翻译服务翻译而成。尽管我们努力确保准确性，但请注意，自动翻译可能包含错误或不准确之处。应以原始语言的文件为权威来源。对于关键信息，建议寻求专业人工翻译。因使用本翻译而导致的任何误解或误读，我们概不负责。