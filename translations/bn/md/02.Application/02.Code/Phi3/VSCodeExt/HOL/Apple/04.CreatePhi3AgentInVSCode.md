...
Visual Studio Code Copilot Chat-এ, আপনি @workspace এর মাধ্যমে পুরো প্রজেক্ট পরিচালনা করতে পারেন। এন্টারপ্রাইজ পরিস্থিতির জন্য, আমরা Copilot Chat-এর এজেন্টকে আরও নমনীয়ভাবে কাস্টমাইজ করতে পারি। 

পূর্ববর্তী ল্যাবে, আমরা MX ফ্রেমওয়ার্ক এবং ক্লাউডকে একত্রিত করে Phi3 এজেন্টের জন্য একটি Visual Studio Code Extension সম্পন্ন করেছি।
...
***NOTE:*** এই প্রজেক্টের জন্য Typescript, WebPack প্রযুক্তিগত সমাধান হিসাবে ব্যবহার করুন।
...
***NOTE:*** অনুগ্রহ করে এটি Visual Studio Code Insiders 1.90+ এ চালান।
...
আপনি টার্মিনালে **npm install** চালাতে পারেন এবং আপনার এক্সটেনশন ডিবাগ করে পরীক্ষা করতে পারেন।
...
অভিনন্দন! আপনি সব ল্যাব সম্পন্ন করেছেন। আশা করি এটি আপনাকে Phi-3 Family এবং GitHub Copilot Chat কীভাবে ব্যবহার করতে হয় তা বোঝার জন্য সাহায্য করবে।
...
**অস্বীকৃতি**:  
এই নথিটি মেশিন-ভিত্তিক এআই অনুবাদ পরিষেবা ব্যবহার করে অনুবাদ করা হয়েছে। আমরা যথাসম্ভব সঠিক অনুবাদের চেষ্টা করি, তবে অনুগ্রহ করে সচেতন থাকুন যে স্বয়ংক্রিয় অনুবাদে ত্রুটি বা অসঙ্গতি থাকতে পারে। মূল ভাষায় থাকা নথিটিকে প্রামাণিক উৎস হিসেবে বিবেচনা করা উচিত। গুরুত্বপূর্ণ তথ্যের ক্ষেত্রে পেশাদার মানব অনুবাদের পরামর্শ দেওয়া হয়। এই অনুবাদ ব্যবহারের ফলে সৃষ্ট কোনো ভুল বোঝাবুঝি বা ভুল ব্যাখ্যার জন্য আমরা দায়ী নই। 