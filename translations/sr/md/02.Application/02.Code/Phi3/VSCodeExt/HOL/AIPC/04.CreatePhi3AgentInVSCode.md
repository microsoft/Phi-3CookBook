...
U Visual Studio Code Copilot Chat-u možete upravljati celim projektom putem @workspace. Za poslovne scenarije, takođe možemo prilagoditi Copilot Chat agenta na fleksibilniji način.

U prethodnom Lab-u, kombinovali smo NPU i cloud kako bismo završili Visual Studio Code ekstenziju za Phi3 agenta.
...
Molimo vas da pogledate ovaj link [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension) za kreiranje projekta ekstenzije.

***NAPOMENA:*** Molimo koristite Typescript i WebPack kao tehnička rešenja za ovaj projekat.

### **2. Dodajte vscode.d.ts**

API za Visual Studio Code Chat još nije integrisan u glavni API koda, ali se trenutno dodaje putem ekstenzija.
...
***NAPOMENA:*** Pokrenite ga u Visual Studio Code Insiders verziji 1.90+.
...
***Preuzmite uzorak koda*** [Kliknite ovde](../../../../../../../../../code/07.Lab/01/AIPC)
...
export function activate(extcontext: vscode.ExtensionContext) {
	...
	const phi3handler: vscode.ChatRequestHandler = async (request: vscode.ChatRequest, context: vscode.ChatContext, stream: vscode.ChatResponseStream, token: vscode.CancellationToken): Promise<IPHI3ChatResult> => {
		...
		if (request.command == 'img') {
			...
			{
				var result = "```txt"+"\n\n"+"Postavite pitanje na sledeći način Vaše pitanje (IMG_URL:https://example.com/image.jpg)"+"\n\n"++"```";
...
Čestitamo! Završili ste sve laboratorijske vežbe. Nadam se da vam je ovo pomoglo da razumete Phi-3 porodicu i kako da koristite GitHub Copilot Chat.
