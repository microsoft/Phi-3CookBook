...
การเรียกใช้ฟังก์ชันปรากฏครั้งแรกในตระกูล Phi Family และตอนนี้คุณสามารถใช้งานได้ผ่าน Phi-4-mini

ตัวอย่างนี้แสดงการจำลองผลการแข่งขันพรีเมียร์ลีก เป้าหมายคือให้ Phi-4-mini แสดงข้อมูลเกมแบบเรียลไทม์ ด้านล่างคือตัวอย่างโค้ด:
...
เอกสารนี้ได้รับการแปลโดยใช้บริการแปลภาษาโดย AI อัตโนมัติ แม้ว่าเราจะพยายามให้การแปลมีความถูกต้องที่สุด แต่โปรดทราบว่าการแปลอัตโนมัติอาจมีข้อผิดพลาดหรือความไม่ถูกต้องเกิดขึ้นได้ เอกสารต้นฉบับในภาษาต้นทางควรถือเป็นแหล่งข้อมูลที่เชื่อถือได้ สำหรับข้อมูลที่สำคัญ แนะนำให้ใช้บริการแปลภาษาจากผู้เชี่ยวชาญที่เป็นมนุษย์ เราไม่รับผิดชอบต่อความเข้าใจผิดหรือการตีความผิดที่เกิดจากการใช้การแปลนี้