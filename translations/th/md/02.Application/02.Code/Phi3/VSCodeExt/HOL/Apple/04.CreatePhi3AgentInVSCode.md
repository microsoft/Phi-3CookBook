...
ใน Visual Studio Code Copilot Chat คุณสามารถจัดการโปรเจกต์ทั้งหมดผ่าน @workspace ได้ สำหรับกรณีในองค์กร เรายังสามารถปรับแต่ง Agent ของ Copilot Chat ได้อย่างยืดหยุ่นมากขึ้น

ใน Lab ก่อนหน้านี้ เราได้รวม MX framework และ cloud เพื่อสร้าง Visual Studio Code Extension สำหรับ Phi3 Agent
...
***NOTE:*** โปรดใช้ Typescript, WebPack เป็นโซลูชันทางเทคนิคสำหรับโปรเจกต์นี้

### **2. เพิ่ม vscode.d.ts**

Visual Studio Code Chat API ยังไม่ได้รวมเข้ากับ Code API แต่ตอนนี้สามารถเพิ่มได้ผ่าน Extensions
...
***NOTE:*** โปรดรันใน Visual Studio Code Insiders 1.90+
...
ยินดีด้วย! คุณได้ทำ Lab ทั้งหมดเสร็จเรียบร้อยแล้ว หวังว่าสิ่งนี้จะช่วยให้คุณเข้าใจ Phi-3 Family และวิธีการใช้ GitHub Copilot Chat
...
เอกสารนี้ได้รับการแปลโดยใช้บริการแปลภาษาโดย AI อัตโนมัติ แม้ว่าเราจะพยายามให้การแปลมีความถูกต้อง แต่โปรดทราบว่าการแปลอัตโนมัติอาจมีข้อผิดพลาดหรือความไม่ถูกต้อง เอกสารต้นฉบับในภาษาต้นทางควรถือเป็นแหล่งข้อมูลที่เชื่อถือได้ สำหรับข้อมูลที่มีความสำคัญ ขอแนะนำให้ใช้บริการแปลภาษาจากผู้เชี่ยวชาญที่เป็นมนุษย์ เราจะไม่รับผิดชอบต่อความเข้าใจผิดหรือการตีความที่ผิดพลาดอันเกิดจากการใช้การแปลนี้