...
![Olive Flow](../../../../../translated_images/olive-flow.e4682fa65f77777f49e884482fa8dd83eadcb90904fcb41a54093af85c330060.en.png)
...
In this lab, you'll download and upload models to the Azure AI Model catalog. So that you can access the model catalog, you'll need to log in to Azure using:
...
1. **Train the model:** Next, the `olive finetune` command fine-tunes the quantized model. Quantizing the model *before* fine-tuning instead of afterward gives better accuracy as the fine-tuning process recovers some of the loss from the quantization.
